...
class App extends React.Component {
  ...
  componentDidMount(){
    ...
    //   }
    // }.bind(this));
    this.restoreState({hintsAllowed:true, puzzlesSolved:[]});
  }
  ...
  render(){
    ...
    if((this.state.mostrarMsgInicial) && (this.props.puzzleCompleto !== true)){
      instrucciones = <InitialMessage mostrarMsgInicial buttonStart={this.state.buttonStart} temporizador={this.state.temporizador} ocultarInstrucciones={this.ocultarInstrucciones} onStartTime={this.onStartTime}/>;
    }
      ...
      puzzle.push(
        {
          ...
          "reverseImgId":pieza.reverse ? pieza.reverse.id : undefined,
          "faceImgPath":pieza.face.path,
          "reverseImgPath":pieza.reverse ? pieza.reverse.path : undefined,
        }
      );
      c++;
    }
  ...
  ocultarInstrucciones(){
    this.setState({mostrarMsgInicial:false, playing_music:true, buttonStart:"Volver"});
  }
